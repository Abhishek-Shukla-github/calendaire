...
const howItWorks = [
  { step: "Sign Up", description: "Create your free Calendaire account" },
  {
    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        ...
        <div className="lg:w-1/2 flex justify-center">
          <div className="relative w-full max-w-md aspect-square">
            <Image alt="Meeting illustration" src={"/poster.png"} layout="fill" objectFit="contain"/>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">
          Join thousands of professionals who trust Calendaire for efficient time
          management.
        </p>
        <Link href={"/dashboard"}>
